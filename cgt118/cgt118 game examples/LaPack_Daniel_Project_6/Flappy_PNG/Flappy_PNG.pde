...
void setup() { 
  size(600, 800); 
  frameRate(40);
  b=loadImage("BallPNG1.png");
  c=loadImage("BackgroundPNG.png");//this is the background 1800 x 800 Px
  w=loadImage("BoundaryPNG.png");//boundary
  m=loadImage("SSPNG.png");
} 
