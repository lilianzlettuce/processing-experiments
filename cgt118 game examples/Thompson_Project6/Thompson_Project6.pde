...
void setup() { 
  size(600, 800); 
  frameRate(40);
  b=loadImage("newbird2.png");
  c=loadImage("newbackground.png");//this is the background 1800 x 800 Px
  w=loadImage("newboundary.png");//boundary
  m=loadImage("newsplash.png");
} 
